...
public extension OperationBuilder where MLIR: ProvidesStandardDialect {
  mutating func buildConstant(
    _ value: MLIR.Attribute, ofType type: Type<MLIR>,
    file: StaticString = #file, line: Int = #line, column: Int = #column) -> MLIR.Value
  {
