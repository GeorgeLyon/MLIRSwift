...
extension Attribute {
  public static func string(_ string: String, in context: Context) -> Self {
    Attribute(c: string.withUnsafeMlirStringRef { mlirStringAttrGet(context.c, $0) })!
  }
